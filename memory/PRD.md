...
- 50+ language support with constrained dual-language detection
...
- **Voice Pipeline**: Whisper (constrained dual-language: native + target) → GPT-5.2 → TTS
...
- **Constrained dual-language Whisper**: Two parallel transcription passes (native + target lang), langdetect picks the best. No more auto-detect from 100+ languages.
