...
- **Web Search tool**: DuckDuckGo-powered, free, no API key. Agent uses it for exam info, interview prep, cultural context, professional vocab, etc.
...
- **web_search**: DuckDuckGo search for real-world info (exams, interviews, culture, media, etc.)
